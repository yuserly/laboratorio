(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_modificar-compra_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./resources/js/views/pages/modificar-compra.js?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./resources/js/views/pages/modificar-compra.js?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      codecompra: this.$route.params.code
    };
  },
  validations: {
    form: {
  ...
  methods: {
    traerinfoplan: function traerinfoplan() {
      var _this = this;

      var idplan = localStorage.getItem("plan");
      this.axios.get("/api/traerplan/".concat(idplan)).then(function (response) {
        console.log(response);
        _this.form.idplan = response.data.id_plan;
        _this.precioplan = response.data.precio;
      });
    },
    traercompra: function traercompra() {
      var _this2 = this;

      this.axios.get("/api/traerventa/".concat(this.codecompra)).then(function (response) {
        console.log(response);
        _this2.form.nombre = response.data.apoderado.nombre;
        _this2.form.correo = response.data.apoderado.email;
        _this2.form.telefono = response.data.apoderado.telefono;
        _this2.form.direccion = response.data.apoderado.direccion;
        _this2.form.region = response.data.apoderado.region;
        _this2.form.comuna = response.data.apoderado.comuna;

        for (var i = 0; i < response.data.detalleventa.length; i++) {
          _this2.formalumnos.push(response.data.detalleventa[i]);
        }

        _this2.calculopagar();
      });
    },
    AddAlumno: function AddAlumno() {
    ...
    calculopagar: function calculopagar() {
    ...
    guardar: function guardar() {
      ...
      if (!this.$v.formalumnostemp.$invalid) {
        if (this.formalumnostemp.index != "na") {
          this.formalumnos[this.formalumnostemp.index].nombre = this.formalumnostemp.nombre;
          this.formalumnos[this.formalumnostemp.index].colegio = this.formalumnostemp.colegio;
          this.formalumnos[this.formalumnostemp.index].curso = this.formalumnostemp.curso;
        } else {
          this.formalumnos.push(this.formalumnostemp);
        }
    ...
    editarRow: function editarRow(alumno, i) {
      this.formalumnostemp.nombre = alumno.nombre;
      this.formalumnostemp.colegio = alumno.colegio;
      this.formalumnostemp.curso = alumno.curso;
      this.formalumnostemp.index = i;
      this.modal = true;
    },
    crearventa: function crearventa() {
      this.submitted = true;

      if (this.formalumnos.length == 0) {
        this.successmsg("Alumno", "Debes agregar uno o varios alumnos", "error");
        return;
      }
      ...
      if (!this.$v.form.$invalid) {
        this.form.codecompra = this.codecompra;
        this.axios.post("/api/aggventa", this.form).then(function (res) {
          console.log(res);
          var url = "/pagar/order/" + res.data.codigo;
          console.log(url);
...
/***/ "./resources/js/views/pages/modificar-compra.vue":
/*!*******************************************************!*\
  !*** ./resources/js/views/pages/modificar-compra.vue ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _modificar_compra_vue_vue_type_template_id_098ce26b___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modificar-compra.vue?vue&type=template&id=098ce26b& */ "./resources/js/views/pages/modificar-compra.vue?vue&type=template&id=098ce26b&");
/* harmony import */ var _modificar_compra_js_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modificar-compra.js?vue&type=script&lang=js& */ "./resources/js/views/pages/modificar-compra.js?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _modificar_compra_js_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _modificar_compra_vue_vue_type_template_id_098ce26b___WEBPACK_IMPORTED_MODULE_0__.render,
  _modificar_compra_vue_vue_type_template_id_098ce26b___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/modificar-compra.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/views/pages/modificar-compra.js?vue&type=script&lang=js&":
/*!*******************************************************************************!*\
  !*** ./resources/js/views/pages/modificar-compra.js?vue&type=script&lang=js& ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_modificar_compra_js_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./modificar-compra.js?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./resources/js/views/pages/modificar-compra.js?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_modificar_compra_js_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/pages/modificar-compra.vue?vue&type=template&id=098ce26b&":
/*!**************************************************************************************!*\
  !*** ./resources/js/views/pages/modificar-compra.vue?vue&type=template&id=098ce26b& ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_modificar_compra_vue_vue_type_template_id_098ce26b___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_modificar_compra_vue_vue_type_template_id_098ce26b___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_modificar_compra_vue_vue_type_template_id_098ce26b___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./modificar-compra.vue?vue&type=template&id=098ce26b& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/modificar-compra.vue?vue&type=template&id=098ce26b&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/modificar-compra.vue?vue&type=template&id=098ce26b&":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/modificar-compra.vue?vue&type=template&id=098ce26b& ***!
  \*****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          _c(
            ...
            [
              _c("div", { staticClass: "container" }, [
                ...
                _c("div", { staticClass: "row justify-content-center" }, [
                  _c("div", { staticClass: "col-md-6" }, [
                    ...
                    _vm._v(" "),
                    _c("form", { staticClass: "datosbasicos" }, [
                      _c("div", { staticClass: "form-row" }, [
                        _c("div", { staticClass: "form-group col-12" }, [
                          _c("input", {
                            ...
                            class: {
                              "is-invalid":
                                _vm.submitted && _vm.$v.form.nombre.$error
                            },
                            attrs: {
                              type: "text",
                          ...
                          _vm.submitted && _vm.$v.form.nombre.$error
                            ? _c("div", { staticClass: "invalid-feedback" }, [
                                !_vm.$v.form.nombre.required
                                  ? _c("span", [_vm._v("Nombre requerido.")])
                                  : _vm._e()
                              ])
                            : _vm._e()
                        ])
                        ...
                        _c(
                          ...
                          [
                            _c("input", {
                              ...
                              class: {
                                "is-invalid":
                                  _vm.submitted && _vm.$v.form.correo.$error
                              },
                              attrs: {
                                type: "email",
                            ...
                            _vm.submitted && _vm.$v.form.correo.$error
                              ? _c("div", { staticClass: "invalid-feedback" }, [
                                  !_vm.$v.form.correo.required
                                    ? _c("span", [_vm._v("Email requerido.")])
                                    : _vm._e()
                                ])
                              : _vm._e()
                          ]
                ...
                _c("div", { staticClass: "row justify-content-center" }, [
                  _c("div", { staticClass: "col-md-6" }, [
                    ...
                    _c(
                      ...
                      [
                        _c("h6", { staticClass: "mb-3" }, [_vm._v("Alumnos")]),
                        _vm._v(" "),
                        _c(
                          "button",
                          {
                            directives: [
                              {
                                name: "b-modal",
                                rawName: "v-b-modal.crearalumno",
                                modifiers: { crearalumno: true }
                              }
                            ],
                            staticClass: "btn btn-outline-primary ml-2 btn-add",
                            attrs: { type: "button" },
                            on: {
                              click: function($event) {
                                return _vm.AddAlumno()
                              }
                            }
                          },
                          [
                    ...
                    _vm.formalumnos
                      ? _c(
                          ...
                          _vm._l(_vm.formalumnos, function(alumno, i) {
                            return _c(
                              "li",
                              {
                                key: i,
                      ...
                      _c("div", { staticClass: "form-row" }, [
                        _c("div", { staticClass: "form-group col-12" }, [
                          _c("input", {
                            ...
                            class: {
                              "is-invalid":
                                _vm.submitted && _vm.$v.form.direccion.$error
                            },
                            attrs: {
                              type: "text",
                              id: "formGroupExampleInput",
                          ...
                          _vm.submitted && _vm.$v.form.direccion.$error
                            ? _c("div", { staticClass: "invalid-feedback" }, [
                                !_vm.$v.form.direccion.required
                                  ? _c("span", [_vm._v("Dirección requerida.")])
                                  : _vm._e()
                              ])
                            : _vm._e()
                        ])
                        ...
                        _c(
                          ...
                          [
                            _c("input", {
                              ...
                              class: {
                                "is-invalid":
                                  _vm.submitted && _vm.$v.form.region.$error
                              },
                              attrs: {
                                type: "text",
                                id: "formGroupExampleInput2",
                            ...
                            _vm.submitted && _vm.$v.form.region.$error
                              ? _c("div", { staticClass: "invalid-feedback" }, [
                                  !_vm.$v.form.region.required
                                    ? _c("span", [_vm._v("Región requerida.")])
                                    : _vm._e()
                                ])
                              : _vm._e()
                          ]
                        ...
                        _c(
                          ...
                          [
                            _c("input", {
                              ...
                              class: {
                                "is-invalid":
                                  _vm.submitted && _vm.$v.form.comuna.$error
                              },
                              attrs: {
                                type: "text",
                                id: "formGroupExampleInput2",
                              ...
                              domProps: { value: _vm.form.comuna },
                              on: {
                                input: function($event) {
                                  if ($event.target.composing) {
                                    return
                            ...
                            _vm.submitted && _vm.$v.form.comuna.$error
                              ? _c("div", { staticClass: "invalid-feedback" }, [
                                  !_vm.$v.form.comuna.required
                                    ? _c("span", [_vm._v("Comuna requerida.")])
                                    : _vm._e()
                                ])
                              : _vm._e()
                          ]
                  ...
                  _c("div", { staticClass: "col-md-6" }, [
                    ...
                    _c("form", { staticClass: "datosbasicos" }, [
                      _c(
                        ...
                        {
                          staticClass:
                            "pl-2  pr-2 pb-3 pt-3 d-flex justify-content-center",
                          staticStyle: {
                            height: "80px",
                        ...
                        [
                          _c(
                            "p",
                            {
                              staticClass: "pl-4 pr-2 pt-1 text-center",
                              staticStyle: {
                                color: "#000",
                                "font-weight": "bold",
                                "line-height": "1",
                            ...
                            [
                              _vm._v(
                                "\n                                    TOTAL: " +
                                  _vm._s(_vm._f("toCurrency")(_vm.totalpagar)) +
                                  " + Envío\n                                "
                              )
                            ]
                          )
              ...
              _c("hr", {
                staticStyle: {
                  "-webkit-box-shadow":
                    "-1px -11px 45px 20px rgba(14,234,175,0.44)",
            ...
            ? _c(
                ...
                [
                  _c("form", { staticClass: "datosbasicos" }, [
                    _c("div", { staticClass: "form-group" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.formalumnostemp.nombre,
                            expression: "formalumnostemp.nombre"
                          }
                        ],
                        staticClass: "form-control",
                        class: {
                          "is-invalid":
                            _vm.submittedalumno &&
                            _vm.$v.formalumnostemp.nombre.$invalid
                        },
                        attrs: {
                          type: "text",
                        ...
                        domProps: { value: _vm.formalumnostemp.nombre },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                      ...
                      _vm._v(" "),
                      _vm.submitted && _vm.$v.formalumnostemp.nombre.$invalid
                        ? _c("div", { staticClass: "invalid-feedback" }, [
                            !_vm.$v.formalumnostemp.nombre.required
                              ? _c("span", [_vm._v("Nombre requerido.")])
                              : _vm._e()
                          ])
                        : _vm._e()
                    ...
                    _c("div", { staticClass: "form-group" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.formalumnostemp.colegio,
                            expression: "formalumnostemp.colegio"
                          }
                        ],
                        staticClass: "form-control",
                        class: {
                          "is-invalid":
                            _vm.submittedalumno &&
                            _vm.$v.formalumnostemp.colegio.$invalid
                        },
                        attrs: {
                          type: "text",
                          id: "colegio",
                        ...
                        domProps: { value: _vm.formalumnostemp.colegio },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                      ...
                      _vm._v(" "),
                      _vm.submitted && _vm.$v.formalumnostemp.colegio.$invalid
                        ? _c("div", { staticClass: "invalid-feedback" }, [
                            !_vm.$v.formalumnostemp.colegio.required
                              ? _c("span", [_vm._v("Colegio requerido.")])
                              : _vm._e()
                          ])
                        : _vm._e()
                    ]),
                    ...
                    _c("div", { staticClass: "form-group" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.formalumnostemp.curso,
                            expression: "formalumnostemp.curso"
                          }
                        ],
                        staticClass: "form-control",
                        class: {
                          "is-invalid":
                            _vm.submittedalumno &&
                            _vm.$v.formalumnostemp.curso.$invalid
                        },
                        attrs: {
                          type: "text",
                          id: "curso",
                        ...
                        domProps: { value: _vm.formalumnostemp.curso },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                      ...
                      _vm._v(" "),
                      _vm.submitted && _vm.$v.formalumnostemp.curso.$invalid
                        ? _c("div", { staticClass: "invalid-feedback" }, [
                            !_vm.$v.formalumnostemp.curso.required
                              ? _c("span", [_vm._v("Curso requerido.")])
                              : _vm._e()
                          ])
                        : _vm._e()
                    ])
                  ...
                  _c(
                    "button",
                    {
                      staticClass: "btn mt-4 btn-agregar-alumno float-end",
                      staticStyle: { "background-color": "#0eeaaf" },
                      attrs: { type: "button" },
                      on: {
                        click: function($event) {
                          return _vm.guardar()
