<script src="./crear_derivacion.js"></script>
    ...
    <Layout>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Nueva Derivación</h4>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body"> 
                        ...
                        >
                            <div class="row">
                                ...
                                <div class="col-12 ">
                                    <div class="mb-3">
                                        <label for="fecha">Derivacion</label>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        <div class="custom-control custom-checkbox">
                                            <input id="invalidCheck" type="checkbox" v-model="form.enviarMail" class="custom-control-input"> 
                                            <label for="invalidCheck" class="custom-control-label">Enviar por correo electronico</label> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button
                                ...
                                type="submit"
                            >
                                <i class="far fa-save"></i> Generar Derivación
                            </button>
                        </form>
                    </div>
                </div>
