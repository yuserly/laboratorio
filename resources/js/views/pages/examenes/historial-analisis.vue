<script src="./historial-analisis.js"></script>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <div class="col-7">
                            <h4 class="card-title">Listado Analisis Emitidos</h4>
                        </div>
                        <div class="col-5">
                            <form
            ...
            <div class="col-12" v-if="existeexamen">
                <div class="card">
                    <div class="card-body">
                        <div class="row mt-4">
                                ...
                                <template v-slot:cell(action)="data">
                                    <ul class="list-inline mb-0">
                                        ...
                                        <li class="list-inline-item">
                                            ...
                                            >
                                                <i
                                                    class="uil-file-edit-alt font-size-18"
                                                ></i>
                                            </a>
                                        </li>
                                        ...
                                        <li class="list-inline-item">
                                            <a
                                                :href="'/imprimirExamenAnalizado/'+data.item.codigo"
                                                target="_blank"
