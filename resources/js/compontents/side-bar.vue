      ...
      <div id="sidebar-menu">
        ...
        <ul class="metismenu list-unstyled" id="side-menu">
          <template v-for="item in menuItems">
            <li class="menu-title" v-if="item.isTitle && $can(item.permiso) " :key="item.id">
              {{ item.label }}
            </li>
            <li v-if="!item.isTitle && !item.isLayout && $can(item.permiso)" :key="item.id">
              <a
                v-if="hasItems(item)"
              ...
              <ul v-if="hasItems(item)" class="sub-menu" aria-expanded="false">
                <li v-for="(subitem, index) of item.subItems" :key="index">
                  <router-link
                    :to="subitem.link"
                    v-if="!hasItems(subitem) && $can(subitem.permiso) "
                    class="side-nav-link-ref"
