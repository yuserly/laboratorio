...
class EnvioDerivacion extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->view('mail.sendderivacion', compact('send_title', 'send_nombres', 'send_apellidos'))
        ->subject($send_title)
        ->attachData($this->pdf->output(), 'derivacion.pdf');
    }
}
